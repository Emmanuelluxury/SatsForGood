...
const RUST_BACKEND_URL = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_RUST_BACKEND_URL || 'http://localhost:3001';
...
async function createInvoice(amount_sats) {
    ...
    const response = await fetch("".concat(RUST_BACKEND_URL, "/create-invoice?").concat(params));
    if (!response.ok) {
...
async function getInvoiceStatus(payment_hash) {
    const response = await fetch("".concat(RUST_BACKEND_URL, "/check-payment?payment_hash=").concat(encodeURIComponent(payment_hash)));
    if (!response.ok) {
...
async function getRecentDonations() {
    const response = await fetch("".concat(RUST_BACKEND_URL, "/recent-donations"));
    if (!response.ok) {
...
async function getDonationStats() {
    const response = await fetch("".concat(RUST_BACKEND_URL, "/donation-stats"));
    if (!response.ok) {
...
async function getDonationReceipt(payment_hash) {
    const response = await fetch("".concat(RUST_BACKEND_URL, "/donation-receipt?payment_hash=").concat(encodeURIComponent(payment_hash)));
    if (!response.ok) {
...
function InvoiceQR(param) {
    ...
    const [timeRemaining, setTimeRemaining] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(3600); // 1 hour in seconds
        ...
        "InvoiceQR.useEffect": ()=>{
            ...
            const timer = setInterval({
                "InvoiceQR.useEffect.timer": ()=>{
                    setTimeRemaining({
                        "InvoiceQR.useEffect.timer": (prev)=>Math.max(0, prev - 1)
                    }["InvoiceQR.useEffect.timer"]);
                }
            }["InvoiceQR.useEffect.timer"], 1000);
            return ({
                "InvoiceQR.useEffect": ()=>clearInterval(timer)
            })["InvoiceQR.useEffect"];
        }
    }["InvoiceQR.useEffect"], [
        timeRemaining
    ...
    const handleOpenInWallet = ()=>{
        const uri = "lightning:".concat(invoice.invoice);
        window.location.href = uri;
    };
    const qrCodeUrl = invoice.qr_code || "https://api.qrserver.com/v1/create-qr-code/?data=".concat(encodeURIComponent(invoice.invoice), "&size=256x256&bgcolor=f3f4f6&color=000000&qzone=1");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: invoice.qr_code ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            src: invoice.qr_code,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
...
_s(InvoiceQR, "sHmTKrSUmikuArFJfZ8/+c8hBh8=", false, function() {
    return [
...
"[project]/Documents/SatsForGood/SatsForGood/src/components/donation-receipt.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function DonationReceiptComponent(param) {
    let { payment_hash, amount_sats, donor_name, recipient, onBack, onNewDonation } = param;
    _s();
    const [receipt, setReceipt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DonationReceiptComponent.useEffect": ()=>{
            const fetchReceipt = {
                "DonationReceiptComponent.useEffect.fetchReceipt": async ()=>{
                    try {
                        const receiptData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDonationReceipt"])(payment_hash);
                        setReceipt(receiptData);
                    } catch (error) {
                        console.error("Failed to fetch receipt:", error);
                        // Fallback receipt data
                        setReceipt({
                            id: "donation_".concat(Date.now()),
                            donor_name,
                            recipient,
                            amount_sats,
                            payment_hash,
                            paid_at: new Date().toISOString(),
                            transaction_id: "lntx1".concat(payment_hash.slice(0, 8), "w").concat(amount_sats),
            ...
            }["DonationReceiptComponent.useEffect.fetchReceipt"];
            fetchReceipt();
        }
    }["DonationReceiptComponent.useEffect"], [
        payment_hash,
    ...
    const handleDownloadReceipt = ()=>{
        if (!receipt) return;
        const receiptText = "\nSATSFORGOOD DONATION RECEIPT\n============================\n\nDonation ID: ".concat(receipt.id, "\nTransaction ID: ").concat(receipt.transaction_id, "\nDate: ").concat(new Date(receipt.paid_at).toLocaleString(), "\nNetwork: ").concat(receipt.network, "\n\nDONOR INFORMATION\n=================\nName: ").concat(receipt.donor_name, "\n\nDONATION DETAILS\n================\nAmount: ").concat(receipt.amount_sats, " satoshis\n").concat(receipt.recipient ? "Recipient: ".concat(receipt.recipient) : '', "\nPayment Hash: ").concat(receipt.payment_hash, "\n\nSTATUS: ✅ CONFIRMED\nThank you for supporting SatsForGood!\n\nFor support, contact: support@satsforgood.org\n    ").trim();
        const blob = new Blob([
            receiptText
        ], {
            type: 'text/plain'
        ...
        a.href = url;
        a.download = "satsforgood-receipt-".concat(receipt.id, ".txt");
    ...
    const handleShareReceipt = async ()=>{
        if (!receipt) return;
        const shareText = "I just donated ".concat(receipt.amount_sats, " sats to SatsForGood! 🔥⚡ #Bitcoin #Lightning #Donate");
        if (navigator.share) {
            try {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            receipt.recipient && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-muted-foreground",
                                children: [
                                    "Going to: ",
                                    receipt.recipient
...
_s(DonationReceiptComponent, "y5EyH+z/HIDzjuvMtaclygE16EA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c = DonationReceiptComponent;
var _c;
__turbopack_context__.k.register(_c, "DonationReceiptComponent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$components$2f$donation$2d$receipt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/SatsForGood/SatsForGood/src/components/donation-receipt.tsx [app-client] (ecmascript)");
...
function Home() {
    ...
    const [completedDonation, setCompletedDonation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        view === "form" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$components$2f$donate$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DonateForm"], {
                                            ...
                                            lineNumber: 110,
                                            columnNumber: 17
                                        }, this) : view === "receipt" && completedDonation ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SatsForGood$2f$SatsForGood$2f$src$2f$components$2f$donation$2d$receipt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DonationReceiptComponent"], {
...
_s(Home, "s6O2BPKujl4/bVJcR7hCvX+GgWM=");
_c = Home;
var _c;
...
//# sourceMappingURL=Documents_SatsForGood_SatsForGood_src_6183cd94._.js.map